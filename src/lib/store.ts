...
function mapTask(data: any): AssemblyTask {
    return {
        ...
        requiredSkills: data.required_domain_skills || data.requiredSkills || ['CABINETRY'],
        taskType: data.task_type || data.taskType || 'GENERAL_ASSEMBLY',
        isKitchenTask: data.is_kitchen_task ?? data.isKitchenTask ?? false,
...
function mapAssembler(data: any, existingAssembler?: Assembler): Assembler {
    ...
    return {
        ...
        skills: data.skills || (existingAssembler?.skills) || ['CABINETRY'],
        certifications: data.certifications || (existingAssembler?.certifications) || {},
        availability: [],
