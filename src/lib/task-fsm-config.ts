...
export const ASSEMBLER_TASK_ACTIONS: Partial<Record<TaskStatus, TaskFSMAction[]>> = {
    ...
    ARRIVED: [
        {
            targetStatus: 'MATERIALS_VERIFIED',
            label: 'Verify Materials',
            confirmTitle: 'Verify Materials on Site',
            confirmMessage: 'Confirm that all METOD cabinets, appliances, and materials have been delivered and are present on-site.',
            confirmButtonText: 'Materials Verified',
            variant: 'default',
            icon: '📦',
        },
        {
            ...
            confirmMessage: 'Confirm that you have started assembly work. (Non-kitchen tasks only)',
    ...
    MATERIALS_VERIFIED: [
        {
            ...
            confirmTitle: 'Start Kitchen Installation',
            confirmMessage: 'Materials are verified. Begin the installation work.',
            confirmButtonText: 'Start Installation',
            variant: 'default',
            icon: '🔧',
        },
        {
...
export const ADMIN_TASK_ACTIONS: Partial<Record<TaskStatus, TaskFSMAction[]>> = {
    ...
    ASSIGNED: [
        {
            targetStatus: 'CONFIRMED',
            label: 'Force Accept',
            confirmTitle: 'Force Accept Job',
            confirmMessage: 'You are forcing the job status to Confirmed on behalf of the assembler.',
            confirmButtonText: 'Force Accept',
            variant: 'secondary',
            icon: '✅',
        },
        {
    ...
    CONFIRMED: [
        {
            targetStatus: 'EN_ROUTE',
            label: 'Force Start Travel',
            confirmTitle: 'Force Start Travel',
            confirmMessage: 'You are forcing the job status to En Route on behalf of the assembler.',
            confirmButtonText: 'Force Start Travel',
            variant: 'secondary',
            icon: '🚗',
        },
        {
    ...
    EN_ROUTE: [
        {
            targetStatus: 'ARRIVED',
            label: 'Force Arrive',
            confirmTitle: 'Force Arrive',
            confirmMessage: 'You are marking this task as Arrived on behalf of the assembler.',
            confirmButtonText: 'Force Arrive',
            variant: 'secondary',
            icon: '📍',
        },
        {
    ...
    ARRIVED: [
        {
            targetStatus: 'MATERIALS_VERIFIED',
            label: 'Force Verify Materials',
            confirmTitle: 'Force Verify Materials',
            confirmMessage: 'You are marking materials as verified on behalf of the assembler.',
            confirmButtonText: 'Force Verify',
            variant: 'secondary',
            icon: '📦',
        },
        {
            targetStatus: 'IN_PROGRESS',
            label: 'Force Start Assembly',
            confirmTitle: 'Force Start Assembly',
            confirmMessage: 'You are marking the assembly as started on behalf of the assembler.',
    ...
    MATERIALS_VERIFIED: [
        {
            targetStatus: 'IN_PROGRESS',
            label: 'Force Start',
            confirmTitle: 'Force Start Installation',
            confirmMessage: 'You are marking the installation as started on behalf of the assembler.',
            confirmButtonText: 'Force Start',
            variant: 'secondary',
            icon: '🔧',
        },
    ...
    IN_PROGRESS: [
        {
            ...
            confirmTitle: 'Force Complete Job',
            confirmMessage: 'You are forcing the job status to Completed on behalf of the assembler.',
    ...
    ISSUE: [
        {
            targetStatus: 'IN_PROGRESS',
            label: 'Resolve & Resume Work',
            confirmTitle: 'Resolve & Resume Work',
            confirmMessage: 'Mark the issue as resolved and let the current assembler continue working.',
        ...
        {
            targetStatus: 'ARRIVED',
            label: 'Resolve & Resume Arrived',
            confirmTitle: 'Resolve & Resume Arrived',
            confirmMessage: 'Mark the issue as resolved and let the current assembler continue from Arrived status.',
            confirmButtonText: 'Resume Arrived',
            variant: 'default',
            icon: '📍',
        },
        {
            targetStatus: 'EN_ROUTE',
            label: 'Resolve & Resume Travel',
            confirmTitle: 'Resolve & Resume Travel',
            confirmMessage: 'Mark the issue as resolved and let the current assembler continue traveling.',
            confirmButtonText: 'Resume Travel',
            variant: 'default',
            icon: '🚗',
        },
        {
...
export const TASK_STATUS_LABELS: Record<TaskStatus, string> = {
    ...
    EN_ROUTE:           'En Route',
    ARRIVED:            'Arrived',
    MATERIALS_VERIFIED: 'Materials Verified',
...
export const TASK_STATUS_COLORS: Record<TaskStatus, { bg: string; text: string; dot: string }> = {
    CREATED:            { bg: 'bg-gray-100',   text: 'text-gray-800',   dot: 'bg-gray-400' },
    SCHEDULING:         { bg: 'bg-blue-50',    text: 'text-blue-800',   dot: 'bg-blue-400' },
    ASSIGNED:           { bg: 'bg-blue-100',   text: 'text-blue-800',   dot: 'bg-blue-500' },
    CONFIRMED:          { bg: 'bg-indigo-100', text: 'text-indigo-800', dot: 'bg-indigo-500' },
    EN_ROUTE:           { bg: 'bg-orange-100', text: 'text-orange-800', dot: 'bg-orange-400' },
    ARRIVED:            { bg: 'bg-yellow-100', text: 'text-yellow-800', dot: 'bg-yellow-400' },
    MATERIALS_VERIFIED: { bg: 'bg-teal-100',   text: 'text-teal-800',   dot: 'bg-teal-500' },
    IN_PROGRESS:        { bg: 'bg-purple-100', text: 'text-purple-800', dot: 'bg-purple-500' },
    COMPLETED:          { bg: 'bg-green-100',  text: 'text-green-800',  dot: 'bg-green-500' },
    VERIFIED:           { bg: 'bg-green-200',  text: 'text-green-900',  dot: 'bg-green-600' },
    ISSUE:              { bg: 'bg-red-100',    text: 'text-red-800',    dot: 'bg-red-500' },
    CANCELLED:          { bg: 'bg-gray-200',   text: 'text-gray-700',   dot: 'bg-gray-400' },
};
